...
/* PACKAGES */
  ...
  static final public PackageStubDeclaration PackageStubDeclaration() throws ParseException {
  String n;
    n = PackageDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new PackageStubDeclaration(n);}
    throw new Error("Missing return statement in function");
  }
 ...
 * CLASSIFIERS *
 ***************/
  static final public ClassifierDefinition ClassifierDefinition() throws ParseException {
  ...
  static final public ClassifierDeclaration ClassifierDeclaration() throws ParseException {
  ClassifierDeclaration d;
    if (jj_2_8(2)) {
      d = ClassDeclaration();
    } else if (jj_2_9(2)) {
  ...
  static final public ClassifierStubDeclaration ClassifierStubDeclaration() throws ParseException {
  ClassifierDeclaration d;
    d = ClassifierDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new ClassifierStubDeclaration(d);}
    throw new Error("Missing return statement in function");
  }
...
/* ACTIVE CLASSES */
  static final public ActiveClassDeclaration ActiveClassDeclaration() throws ParseException {
  ActiveClassDeclaration d = new ActiveClassDeclaration();
  String n;
  QualifiedNameList nl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
  ...
  ActiveClassDeclaration c;
  Member m;
    c = ActiveClassDeclaration();
                                 d = new ActiveClassDefinition(c);
    jj_consume_token(LBRACE);
    label_6:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
...
/* DATA TYPES */
  static final public DataTypeDeclaration DataTypeDeclaration() throws ParseException {
  DataTypeDeclaration d = new DataTypeDeclaration();
  String n;
  QualifiedNameList nl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
  ...
  DataTypeDeclaration t;
    t = DataTypeDeclaration();
                              d = new DataTypeDefinition(t);
    StructuredBody(d);
    {if (true) return d;}
    throw new Error("Missing return statement in function");
  }
...
/* ASSOCIATIONS */
  static final public AssociationDeclaration AssociationDeclaration() throws ParseException {
  AssociationDeclaration d = new AssociationDeclaration();
  String n;
  QualifiedNameList nl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
  ...
  AssociationDeclaration a;
    a = AssociationDeclaration();
                                 d = new AssociationDefinition(a);
    StructuredBody(d);
    {if (true) return d;}
    throw new Error("Missing return statement in function");
  }
...
/* ENUMERATIONS */
  static final public EnumerationDeclaration EnumerationDeclaration() throws ParseException {
  EnumerationDeclaration d = new EnumerationDeclaration();
  String n;
  QualifiedNameList nl;
  ...
  EnumerationDeclaration e;
  Member m;
    e = EnumerationDeclaration();
                                 d = new EnumerationDefinition(e);
    jj_consume_token(LBRACE);
...
/* SIGNALS */
  static final public SignalDeclaration SignalDeclaration() throws ParseException {
  SignalDeclaration d = new SignalDeclaration();
  String n;
  QualifiedNameList nl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
...
/* PROPERTIES */
  ...
  PropertyDeclaration p;
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new PropertyDefinition(p);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public void TypePart(TypedDeclaration d) throws ParseException {
  QualifiedName t;
  Token tc;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ANY:
  ...
  static final public void Multiplicity(TypedDeclaration d) throws ParseException {
  ...
  static final public void MultiplicityRange(TypedDeclaration d) throws ParseException {
  Token t;
  String n;
    if (jj_2_19(2)) {
...
/* OPERATIONS */
  static final public OperationDeclaration OperationDeclaration() throws ParseException {
  OperationDeclaration d = new OperationDeclaration();
  String n;
  QualifiedNameList nl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABSTRACT:
  ...
  OperationDeclaration o;
  Block b;
    o = OperationDeclaration();
    b = Block();
    {if (true) return new OperationDefinition(o, b);}
    throw new Error("Missing return statement in function");
  }

  static final public OperationStubDeclaration OperationStubDeclaration() throws ParseException {
  OperationDeclaration o;
    o = OperationDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new OperationStubDeclaration(o);}
    throw new Error("Missing return statement in function");
  }

  static final public void FormalParameters(ParameterSetDeclaration d) throws ParseException {
  ...
  static final public void FormalParameterList(ParameterSetDeclaration d) throws ParseException {
  FormalParameter p;
    p = FormalParameter();
                          d.addParameter(p);
    label_9:
...
/* CONSTRUCTORS */
  static final public OperationDeclaration ConstructorDeclaration() throws ParseException {
  OperationDeclaration d = new OperationDeclaration();
  String n;
  ...
  Block b;
    ...
    b = ConstructorBody();
    {if (true) return new ConstructorDefinition(o, b);}
    throw new Error("Missing return statement in function");
  }

  static final public ConstructorStubDeclaration ConstructorStubDeclaration() throws ParseException {
  OperationDeclaration o;
    o = ConstructorDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new ConstructorStubDeclaration(o);}
    throw new Error("Missing return statement in function");
  }
  ...
  Block b;
    if (jj_2_20(2147483647)) {
      jj_consume_token(LBRACE);
      b = ExplicitConstructorInvocations();
      label_10:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case ACCEPT:
  ...
  static final public Block ExplicitConstructorInvocations() throws ParseException {
  Block b = new Block();
  Statement s;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case THIS:
  ...
  Tuple t;
    ...
    t = Tuple();
    jj_consume_token(SEMICOLON);
    {if (true) return new AlternativeConstructorInvocation(n, t);}
    throw new Error("Missing return statement in function");
  }
  ...
  Tuple t;
    ...
    t = Tuple();
    jj_consume_token(SEMICOLON);
    {if (true) return new SuperclassConstructorInvocation(n, t);}
    throw new Error("Missing return statement in function");
  }

/* DESTRUCTORS */
  static final public OperationDeclaration DestructorDeclaration() throws ParseException {
  OperationDeclaration d = new OperationDeclaration();
  String n;
  ...
  OperationDeclaration o;
  Block b;
    o = DestructorDeclaration();
    b = Block();
    {if (true) return new DestructorDefinition(o, b);}
    throw new Error("Missing return statement in function");
  }

  static final public DestructorStubDeclaration DestructorStubDeclaration() throws ParseException {
  OperationDeclaration o;
    o = DestructorDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new DestructorStubDeclaration(o);}
    throw new Error("Missing return statement in function");
  }
...
/* RECEPTIONS */
  ...
  static final public SignalDeclaration SignalReceptionDeclaration() throws ParseException {
  SignalDeclaration d = new SignalDeclaration();
  String n;
  QualifiedNameList nl;
    jj_consume_token(RECEIVE);
  ...
  SignalDeclaration s;
    s = SignalReceptionDeclaration();
                                     d = new SignalReceptionDefinition(s);
    StructuredBody(d);
    {if (true) return d;}
    throw new Error("Missing return statement in function");
  }

  static final public SignalReceptionStubDeclaration SignalReceptionStubDeclaration() throws ParseException {
  SignalDeclaration s;
    s = SignalReceptionDeclaration();
    jj_consume_token(SEMICOLON);
    {if (true) return new SignalReceptionStubDeclaration(s);}
    throw new Error("Missing return statement in function");
  }
...
/* ACTIVITIES */
  static final public ActivityDeclaration ActivityDeclaration() throws ParseException {
  ParameterSetDeclaration d = new ParameterSetDeclaration();
  String n;
    ...
    {if (true) return new ActivityDeclaration(n,d);}
    throw new Error("Missing return statement in function");
  }

  static final public ActivityDefinition ActivityDefinition() throws ParseException {
  ActivityDeclaration a;
  Block b;
    a = ActivityDeclaration();
    b = Block();
    {if (true) return new ActivityDefinition(a, b);}
    throw new Error("Missing return statement in function");
  }
...
/* FOR STATEMENTS */
  ...
  Expression e;
    ...
    jj_consume_token(IN);
    e = Expression();
    {if (true) return new ForVariableDefinition(n, e);}
    throw new Error("Missing return statement in function");
  }
...
/* COLLECTION VALUE EXPRESSIONS */
  ...
  QualifiedName t;
  TypedDeclaration d = new TypedDeclaration();
...
/* ADDED */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x24680000,0x0,0x0,0x0,0x0,0x20000,0x2000000,0x2000000,0x20000,0x20000,0x24680000,0x24680000,0x0,0x400000,0x0,0x400000,0x80000,0x0,0x0,0x246a0000,0x20000,0x0,0x80000,0x80000,0x0,0x246a0000,0x0,0x0,0x20000,0x0,0x24680000,0x0,0x80000,0x0,0x20000,0x20000,0x0,0x80000,0x0,0x0,0x0,0x20000,0x80000,0x0,0x80000,0x80000,0x0,0x0,0x80000000,0x0,0x0,0x1000000,0x1000000,0x0,0x0,0x0,0x0,0x80000,0x0,0x0,0x20000,0x0,0x20000,0x0,0x49100000,0x0,0x0,0x0,0x0,0x0,0x0,0x49120000,0x20000,0x49100000,0x0,0x0,0x0,0x0,0x10000000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x1000000,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x80400042,0x3800000,0x2800000,0x8000,0x2800000,0x0,0x0,0x0,0x2800000,0x0,0x80400042,0x80400042,0x40,0x0,0x40,0x0,0x0,0x20000000,0x0,0x8380004b,0x0,0x3800000,0x9,0x0,0x20000000,0x8780004b,0x10,0x0,0x0,0x3800000,0x8000004b,0x4000000,0x0,0x20000000,0x2000000,0x0,0x2000000,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x20000000,0x9,0x9,0x4000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100000,0x20000,0x0,0x0,0x0,0x8000000,0x203000,0x0,0x0,0x203000,0x50050490,0x0,0x40000000,0x0,0x0,0x20000000,0x0,0x50050490,0x0,0x50050490,0x0,0x0,0x20,0x80000,0x0,0x4,0x0,0x0,0x0,0x0,0x80000,0x0,0x100,0x100,0x40050000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40010000,0x0,0x0,0x40050000,0x0,0x0,0x0,0x40010000,0x0,0x0,0x0,0x40050000,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40050000,0x40050000,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4200,0x4200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x220,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x220,0x0,0x0,0x220,0x0,0x0,0x220,0x0,0x80220,0x0,0x0,0x220,0x0,0x0,0x0,0x220,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x220,0x220,0x0,0x80000000,0x0,0x200000,0x0,0x10000230,0x10000220,0x4000,0x0,0x0,0x4000,0x0,0x8000000,0x0,0x0,0x1000000,0x0,0x0,0x108ae22b,0x80000,0x2,0x2000000,0x2000000,0x0,0x8000000,0x108ae22b,0x0,0x108ae22b,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x1000000,0x8,0x880000,0x0,0x4,0x0,0x4,0x1002e222,0x200000,0x220000,0x200000,0x2000000,0x20000000,0x2000000,0xe000,0x10020222,0xe000,0x20000,0x1002e222,0x1000000,0x1000000,0x0,0x1002e222,0x2000000,0x20200000,0x4000,0x1002e222,0x10000220,0x1000000,0x4000000,0x20000,0x1000000,0x200000,0x0,0x0,0x1002e222,0x1002e222,0x1002e222,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x10000,0x0,0x0,0x10000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8001f034,0x0,0x0,0x0,0x0,0x0,0x0,0x8001f034,0x0,0x8001f034,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80010000,0x0,0x0,0x0,0x0,0x0,0x0,0x10000,0x80000000,0x10000,0x0,0x8001f024,0x0,0x0,0x80000000,0x80010000,0x0,0x0,0x10000,0x8001f024,0x0,0x0,0x0,0x0,0x0,0x0,0x3000,0x3000,0x8001f024,0x80010024,0x80010024,0xf024,0xc000,0x230000,0x230000,0xc000,0xc000,0x183,0x183,0x0,0x0,0x240,0x240,0x40000,0x100000,0x80000,0x800,0x400,0x8,0x7f800000,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x0,0x1,0x1,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
