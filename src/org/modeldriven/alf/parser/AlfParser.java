...
public class AlfParser implements AlfParserConstants {
  ...
  public static boolean isUnit(String option) {
    return option.equals("u") || option.equals("U");
  }

  public static boolean isStatement(String option) {
    return option.equals("s") || option.equals("S");
  }

  public static boolean isExpression(String option) {
    return option.equals("e") || option.equals("E");
  }

  public static boolean isLegalOption(String option) {
    return isUnit(option) || isStatement(option) || isExpression(option);
  }

  public static void parse(String fileName, String option) {
    AlfParser parser;
    ...
    try {
      ...
      } else if (isStatement(option)) {
        element = parser.StatementSequence();
      } else if (isExpression(option)) {
  ...
  public static void main(String args[]) {
    ...
    if (args.length == 0) {
      ...
      if (args[0].substring(0,1).equals("-")) {
        option = args[0].substring(1,2);
      } else {
        option = "u";
        fileName = args[0];
      }
    } else if (args.length == 2 && args[0].substring(0,1).equals("-")) {
      option = args[0].substring(1,2);
      fileName = args[1];
    }
    ...
    if (isLegalOption(option)) {
      ...
      System.out.println("         alfp [-use] < inputfile");
