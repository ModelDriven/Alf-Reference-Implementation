...
public class Fuml {
	...
	private org.modeldriven.alf.eclipse.moka.execution.Locus locus;

	public org.modeldriven.alf.eclipse.moka.execution.Locus getLocus() {
		return this.locus;
	}
	...
	private void createLocus() {
		this.locus = new org.modeldriven.alf.eclipse.moka.execution.Locus();
	...
	private void createAlfLibraryBehaviorPrototype(
		...
		org.modeldriven.alf.eclipse.moka.library.OpaqueBehaviorExecution prototype = null;
		try {
			prototype = new org.modeldriven.alf.eclipse.moka.library.OpaqueBehaviorExecution(libraryClass.newInstance());
		...
		try {
			...
			if (behavior instanceof OpaqueBehavior) {
				...
				execution = prototype == null? new UnimplementedBehaviorExecution():
					new org.modeldriven.alf.eclipse.moka.execution.OpaqueBehaviorExecution(prototype);
