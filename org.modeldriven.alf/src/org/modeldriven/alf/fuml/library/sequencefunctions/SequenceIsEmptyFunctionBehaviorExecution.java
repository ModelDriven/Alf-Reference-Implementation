...
public class SequenceIsEmptyFunctionBehaviorExecution implements OpaqueBehaviorExecution {
    ...
    public void doBody(List<ParameterValue> inputs, List<ParameterValue> outputs, Debug debug) {
        ...
        debug.println("[doBody] IsEmpty result = " + result);
    ...
    public OpaqueBehaviorExecution new_() {
        return new SequenceIsEmptyFunctionBehaviorExecution();
    }
