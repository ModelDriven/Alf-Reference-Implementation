...
public class SequenceExcludesFunctionBehaviorExecution implements OpaqueBehaviorExecution {
    ...
    public void doBody(List<ParameterValue> inputs, List<ParameterValue> outputs, Debug debug) {
        ...
        debug.println("[doBody] Excludes result = " + result);
    ...
    public OpaqueBehaviorExecution new_() {
        return new SequenceExcludesFunctionBehaviorExecution();
    }
