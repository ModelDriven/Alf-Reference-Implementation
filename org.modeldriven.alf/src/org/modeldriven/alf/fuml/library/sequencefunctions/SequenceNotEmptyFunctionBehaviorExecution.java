...
public class SequenceNotEmptyFunctionBehaviorExecution implements OpaqueBehaviorExecution {

    @Override
    public void doBody(List<ParameterValue> inputs, List<ParameterValue> outputs, Debug debug) {
        final boolean result = !inputs.get(0).getValues().isEmpty();
        debug.println("[doBody] NotEmpty result = " + result);
    ...
    public OpaqueBehaviorExecution new_() {
        return new SequenceNotEmptyFunctionBehaviorExecution();
    }
