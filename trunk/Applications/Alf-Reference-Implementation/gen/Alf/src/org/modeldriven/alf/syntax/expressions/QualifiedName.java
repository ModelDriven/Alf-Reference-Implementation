...
public class QualifiedName extends SyntaxNode {
	...
	private ArrayList<NameBinding> nameBindings = new ArrayList<NameBinding>();

	public void addNameBinding(NameBinding nameBinding) {
		this.nameBindings.add(nameBinding);
	} // addNameBinding

	public ArrayList<NameBinding> getNameBindings() {
	...
	public void addName(String name) {
		...
		this.addNameBinding(nameBinding);
	} // addName

	public ArrayList<String> getNames() {
		ArrayList<String> names = new ArrayList<String>();

		for (NameBinding nameBinding : this.getNameBindings()) {
			names.add(nameBinding.getName());
		}
	...
	public void appendBinding(TemplateBinding binding) {
		ArrayList<NameBinding> nameBindings = this.getNameBindings();
		int n = nameBindings.size();
		if (n > 0) {
			NameBinding lastBinding = nameBindings.get(n - 1);
			lastBinding.setBinding(binding);
		}
	} // appendBinding
	...
	public String toString() {
		...
		for (int i = 0; i < nameBindings.size(); i++) {
			s.append(nameBindings.get(i).toString());
			if (i < nameBindings.size() - 1) {
				s.append("::");
			}
		}
